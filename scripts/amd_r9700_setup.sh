...
echo ""
echo "  NOTE: vLLM installs but gfx1201 (RDNA 4) is not yet recognized by the vLLM"
echo "  engine as of May 2026. The consultant model must be served remotely or via"
echo "  Ollama. Check current support status at any time with:"
echo "       bash scripts/test_vllm_rocm.sh"
echo "  Upstream tracking: https://github.com/vllm-project/vllm/issues"
echo ""
