...
PATTERNS: tuple[tuple[str, str], ...] = (
    ...
    # === level-up run (today) — many-shot N-sweep ===
    ("A3B + 5-shot mini", "qwen35b-a3b-local-mini-unified-fewshot5"),
    ("A3B + 7-shot mini", "qwen35b-a3b-local-mini-unified-fewshot7"),
    ("A3B + 10-shot mini", "qwen35b-a3b-local-mini-unified-fewshot10"),
    ("A3B + 10-shot smoke", "qwen35b-a3b-local-smoke-unified-fewshot10"),
    ("A3B + 10-shot n=50", "qwen35b-a3b-local-n50-unified-fewshot10"),
    # === level-up run — BERT-consultant integration ===
    ("BERT + A3B smoke", "bert-consultant-a3b-smoke"),
    ("BERT + A3B mini", "bert-consultant-a3b-mini"),
    ("BERT + A3B n=50", "bert-consultant-a3b-n50"),
    ("BERT(rich) + A3B smoke", "bert-consultant-richeval-smoke"),
    ("BERT(rich) + A3B mini", "bert-consultant-richeval-mini"),
    ("BERT v1 + A3B + 10-shot mini", "bert-consultant-fewshot10-mini"),
    ("BERT v1 + A3B + 10-shot n=50", "bert-consultant-fewshot10-n50"),
    ("BERT v2 + A3B + 10-shot mini", "bert-v2-consultant-fewshot10-mini"),
    ("BERT v2 + A3B + 10-shot n=50", "bert-v2-consultant-fewshot10-n50"),
    ("BERT + Gemma 31B + 10-shot smk", "bert-consultant-fewshot10-gemma-smoke"),
    ("BERT + Gemma 31B + 10-shot mini", "bert-consultant-fewshot10-gemma-mini"),
    ("BERT + Gemma 31B + 10-shot n=50", "bert-consultant-fewshot10-gemma-n50"),
    ("BERT + A4B + 10-shot mini", "bert-consultant-fewshot10-a4b-mini"),
    ("BERT + A4B + 10-shot n=50", "bert-consultant-fewshot10-a4b-n50"),
)
...
def fmt_row(label: str, m: dict | None) -> str:
    if m is None:
        return (
            f"| {label:35s} |   _pending_ |   _pending_ |   _pending_ |   _pending_ |   _pending_ |"
        )
