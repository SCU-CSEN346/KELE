...
ax.set_xlabel("Unified score   (½ · stage_bal  +  ½ · judge × 10)",
              fontsize=14, labelpad=10)
ax.set_xlim(48, 96)
ax.set_title("Memorization-resistant unified-score leaderboard  (n = 681)",
             pad=14, fontsize=18)
...
ax.text(small_box_x, (i_ceiling + i_locked) / 2,
        "+2.18\nvs frontier\nceiling",
        ha="left", va="center", fontsize=11, fontweight="bold", color=ps.GOLD,
        bbox=dict(boxstyle="round,pad=0.45", facecolor=ps.LIGHT_GOLD,
...
ax.text(big_box_x, (i_baseline + i_locked) / 2,
        f"+{big_gap:.2f}\nvs paper\nbaseline",
        ha="left", va="center", fontsize=11, fontweight="bold", color=ps.RED,
        bbox=dict(boxstyle="round,pad=0.50", facecolor=ps.LIGHT_RED,
