...
\paragraph{Future work.} (a)~A broader prompt-engineering tournament (10 utilizations $\times\,n{=}50$, then promote top-3 composition to $n{=}681$) targets closing the residual R-1 gap. (b)~Bilingual co-training of the classifier on the union of SocratDataset and SocratDataset-EN, currently transferable cross-lingually with a $-9.24$~pp macro drop. (c)~A within-stratum stratified $n{=}200$--$300$ sampling protocol may match $n{=}400$ random's decision precision at lower cost; we did not measure this. (d)~An English-domain Socratic-teaching benchmark constructed natively (not as a translation) would help separate language-bound from method-bound effects, and a multi-subject expansion beyond elementary-school science would validate cross-domain transfer of the deterministic-classifier integration.
