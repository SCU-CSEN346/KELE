...
| 6 | `t4-bert-gemma-fewshot10-n50-fixed` | 285 | **68.94** | 66.44 | 56.13 |  8.18 | 51.58 | 38.76 |
...
| 9 | `bge-small-bert-gemma-fewshot10-n50-fixed` | 283 | **67.65** | 64.95 | 52.73 |  8.26 | 45.94 | 38.69 |
| 10 | `t4-bert-a3b-fewshot10-n50-fixed` | 288 | **66.91** | 64.57 | 58.62 |  7.52 | 54.86 | 35.67 |
| 11 | `t4-bert-qwen27b-fewshot10-n50-fixed` | 282 | **66.89** | 64.65 | 58.68 |  7.51 | 53.19 | 35.28 |
| 12 | `bert-a3b-composed-top3-n50` | 276 | **65.79** | 63.44 | 56.73 |  7.49 | 48.19 | 37.64 |
| 13 | `bge-small-bert-qwen27b-fewshot10-n50-fixed` | 271 | **65.65** | 63.35 | 57.15 |  7.41 | 49.08 | 34.91 |
| 14 | `t4-bert-qwen27b-nothink-fewshot10-n50-fixed` | 291 | **65.54** | 62.86 | 55.45 |  7.56 | 51.89 | 37.38 |
...
| 17 | `bge-small-bert-qwen27b-nothink-fewshot10-n50-fixed` | 286 | **64.25** | 61.64 | 52.62 |  7.59 | 46.85 | 37.81 |
| 18 | `bge-small-bert-a3b-fewshot10-n50-fixed` | 280 | **63.70** | 61.10 | 52.48 |  7.49 | 45.36 | 34.99 |
...
| 9 | 1 | -8 | `t4-bert-a3b-fewshot10-n50-fixed` | 288 | 54.86 | **58.62** | 53.93 | 61.58 |  7.52 | 35.67 |
...
| 18 | 21 | +3 | `bge-small-bert-qwen27b-fewshot10-n50-fixed` | 271 | 49.08 | **57.15** | 52.56 | 64.76 |  7.41 | 34.91 |
...
| 23 | 8 | -15 | `t4-bert-gemma-fewshot10-n50-fixed` | 285 | 51.58 | **56.13** | 51.13 | 59.63 |  8.18 | 38.76 |
...
| 26 | 7 | -19 | `t4-bert-qwen27b-nothink-fewshot10-n50-fixed` | 291 | 51.89 | **55.45** | 50.09 | 57.90 |  7.56 | 37.38 |
...
| 33 | 37 | +4 | `bge-small-bert-gemma-fewshot10-n50-fixed` | 283 | 45.94 | **52.73** | 47.32 | 58.29 |  8.26 | 38.69 |
| 34 | 20 | -14 | `bert-consultant-richeval-mini` | 126 | 49.21 | **52.67** | 47.08 | 55.25 |   —   | 26.53 |
| 35 | 32 | -3 | `bge-small-bert-qwen27b-nothink-fewshot10-n50-fixed` | 286 | 46.85 | **52.62** | 47.41 | 57.42 |  7.59 | 37.81 |
| 36 | 39 | +3 | `bge-small-bert-a3b-fewshot10-n50-fixed` | 280 | 45.36 | **52.48** | 47.28 | 58.41 |  7.49 | 34.99 |
...
| 42 | 45 | +3 | `bert-v2-consultant-fewshot10-n50` | 287 | 43.90 | **50.60** | 45.29 | 56.16 |   —   | 37.12 |
...
| 46 | 42 | -4 | `bert-v2-consultant-fewshot10-mini` | 142 | 44.37 | **49.08** | 43.43 | 52.81 |   —   | 33.55 |
...
| +4 | 33 | 37 | `bge-small-bert-gemma-fewshot10-n50-fixed` | 283 | 45.94 → 52.73 | 72.7% |
| +3 | 3 | 6 | `tournament-cell-1-length_budget` | 281 | 51.96 → 59.50 | 83.9% |
| +3 | 10 | 13 | `bert-gemma-composed-top3-n50` | 278 | 50.72 → 58.48 | 87.5% |
| +3 | 18 | 21 | `bge-small-bert-qwen27b-fewshot10-n50-fixed` | 271 | 49.08 → 57.15 | 84.6% |
| +3 | 36 | 39 | `bge-small-bert-a3b-fewshot10-n50-fixed` | 280 | 45.36 → 52.48 | 75.0% |
...
|---:|---:|---:|---|---:|---|---:|
| -19 | 26 | 7 | `t4-bert-qwen27b-nothink-fewshot10-n50-fixed` | 291 | 51.89 → 55.45 | 34.4% |
| -15 | 23 | 8 | `t4-bert-gemma-fewshot10-n50-fixed` | 285 | 51.58 → 56.13 | 33.3% |
...
| -3 | 35 | 32 | `bge-small-bert-qwen27b-nothink-fewshot10-n50-fixed` | 286 | 46.85 → 52.62 | 25.3% |
...
| 18 | `bge-small-bert-qwen27b-fewshot10-n50-fixed` | 271 | 100.00 | 35.59 | 23.66 | 41.86 | 84.62 |
...
| 23 | `t4-bert-gemma-fewshot10-n50-fixed` | 285 | 100.00 | 42.37 | 33.33 | 38.30 | 66.67 |
