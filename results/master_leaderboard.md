...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| qwen3.5 × SocratTeachLLM · fewshot10 · n=681 [contaminated] | 56.50 | 47.45 | 28.70 | 19.90 | — | — | 80.22 | 3993 |
| bert-fixed × SocratTeachLLM · fewshot10 · n=681 [contaminated] | 52.66 | 47.30 | 28.70 | 19.41 | — | — | 76.31 | 3870 |
...
| qwen3.5 × GLM-4-9B-Chat-base · fewshot10 · n=681 [STL base — true ceiling] | 48.72 | 33.03 | 15.90 | 7.93 | — | — | 65.23 | 4220 |
...
| bert-fixed × GLM-4-9B-Chat-base · fewshot10 · n=681 [STL base — true ceiling] | 43.71 | 32.30 | 15.83 | 7.62 | — | — | 59.86 | 3651 |
...
| qwen3.5 × SocratTeachLLM · fewshot10 · n=681 [contaminated] | 47.45 | 28.70 | 19.90 | 96.05 | 56.50 | — | — |
| bert-fixed × SocratTeachLLM · fewshot10 · n=681 [contaminated] | 47.30 | 28.70 | 19.41 | 95.41 | 52.66 | — | — |
...
| qwen3.5 × GLM-4-9B-Chat-base · fewshot10 · n=681 [STL base — true ceiling] | 33.03 | 15.90 | 7.93 | 56.86 | 48.72 | — | — |
| bert-fixed × GLM-4-9B-Chat-base · fewshot10 · n=681 [STL base — true ceiling] | 32.30 | 15.83 | 7.62 | 55.75 | 43.71 | — | — |
...
SocratTeachLLM is a LoRA fine-tune of THUDM/glm-4-9b-chat. At matched n=681 + fewshot10 + consultant + vLLM serving, the only difference between paired rows is the LoRA adapter. The Δ row shows what the fine-tune actually contributes; the ROUGE/state-acc ratio quantifies how much of that delta is contamination.

| Consultant | Cell | State acc | Stage-bal | R-1 | R-2 | BLEU-4 |
|---|---|---:|---:|---:|---:|---:|
| bert-fixed | GLM-4-9B-Chat-base | 43.71 | 52.77 | 32.30 | 15.83 | 7.62 |
| bert-fixed | SocratTeachLLM [contaminated] | 52.66 | 60.10 | 47.30 | 28.70 | 19.41 |
| bert-fixed | **Δ (STL − base)** | **+8.95** | **+7.33** | **+15.00** | **+12.87** | **+11.79**  ·  ROUGE-1/state ratio = 1.68× |
| qwen3.5 | GLM-4-9B-Chat-base | 48.72 | 53.37 | 33.03 | 15.90 | 7.93 |
| qwen3.5 | SocratTeachLLM [contaminated] | 56.50 | 61.78 | 47.45 | 28.70 | 19.90 |
| qwen3.5 | **Δ (STL − base)** | **+7.78** | **+8.41** | **+14.42** | **+12.80** | **+11.97**  ·  ROUGE-1/state ratio = 1.85× |

**Reading:** the fine-tune adds ~+8 pp pedagogical state accuracy but ~+15 pp ROUGE-1. ROUGE-1 inflation is ~1.8× the pedagogical gain at matched everything — the cleanest contamination signature in the experimental record, complementing the four prior diagnostics (surface-form inversion, n-gram-length scaling, cross-lingual translation, synthetic clean-probe collapse). STL retains a real fine-tune lift on state accuracy; the surface-form portion of its advantage is training-data memorization.
