...
> **Latest (2026-05-25) — first n=681 parity sub-leaderboard cell landed (TODO #14 cell #3).** `qwen3.5 × A3B-35B · fewshot10 · n=681` ran overnight (9h41m + $16.53 Sonnet judge) and landed at unified **67.81** (#11 master, #5 stage_bal at 60.02). The locked headline (`bert × Gemma-31B · fewshot10 · n=681`, unified **68.65**, #7) is unmoved; the frontier ceiling (`bert × Claude-Sonnet · top3 · n=681`, unified **70.06**, #2) is unmoved. The n=50 → n=681 promotion shifts per-stage profile by ~7 pp (closure jumps, b/c each drop) and costs ~1 pt on stage_bal as closure dominance only emerges at full sampling. The **canonical-scale parity gap** between best open-weight and best frontier is now **1.41 unified pts** (legacy locked headline) or **2.25 pts** (new qwen3.5 × A3B at n=681) — wider than the 1.12-pt screening-tier claim and the right number for the paper. Three more parity cells (`bert-fixed × Gemma-31B · n=681`, `qwen3.5 × Gemma-31B · n=681`, `qwen3.5 × Qwen-27B · no-think · n=681`) still queued under TODO #14.
>
...
### Unified-ranked tier (36 cells with both stage_bal AND LLM-judge)
...
| 6 | `qwen3.5 × Gemma-31B · fewshot10 · n=50` ← honest cross-teacher winner (screening) | 285 | **68.94** | 56.13 | 8.18 | 51.58 | 38.76 |
...
| 11 | `qwen3.5 × A3B-35B · fewshot10 · n=681` ← **TODO #14 cell #3** (first n=681 parity cell, 2026-05-25) | 3968 | **67.81** | 60.02 | 7.56 | 53.40 | 34.10 |
| 12 | `bert-fixed × Gemma-31B · fewshot10 · n=50` | 283 | **67.65** | 52.73 | 8.26 | 45.94 | 38.69 |
| 13 | `qwen3.5 × Gemma-31B · fewshot10 · EN · RETRY · n=100 · seed=42` ← cross-lingual Stage 1 (screening; superseded by #21) | 584 | **67.30** | 52.10 | 8.25 | 46.58 | 11.66 |
| 14 | `qwen3.5 × A3B-35B · fewshot10 · n=50` | 288 | **66.91** | 58.62 | 7.52 | 54.86 | 35.67 |
| 15 | `qwen3.5 × Qwen-27B · think · fewshot10 · n=50` | 282 | **66.89** | 58.68 | 7.51 | 53.19 | 35.28 |
| 16 | `qwen3.5 × Gemma-31B · fewshot10 · EN · PARTIAL · n=61` | 351 | **66.66** | 50.84 | 8.25 | 45.01 | 10.88 |
| 17 | `qwen3.5 × Qwen-27B · phase3 · no-think · n=200 · seed=42` | 1172 | **66.55** | 57.45 | 7.56 | 52.13 | 37.11 |
| 18 | `bert × A3B-35B · composed · top3 · n=50` | 276 | **65.79** | 56.73 | 7.49 | 48.19 | 37.64 |
| 19 | `bert-fixed × Qwen-27B · think · fewshot10 · n=50` | 271 | **65.65** | 57.15 | 7.41 | 49.08 | 34.91 |
| 20 | `qwen3.5 × Qwen-27B · no-think · fewshot10 · n=50` | 291 | **65.54** | 55.45 | 7.56 | 51.89 | 37.38 |
| 21 | `qwen3.5 × Gemma-31B · fewshot10 · EN · canonical · n=400 · seed=42` ← **cross-lingual Stage 1 CONFIRMED (canonical)** | 2324 | **65.11** | 49.12 | 8.11 | 42.34 | 10.45 |
| ⚠️ 22 | `bert-fixed × SocratTeachLLM · fewshot10 · n=50` | 278 | **65.09** | 58.34 | 7.18 | 52.52 | 47.44 |
| 23 | `bert × Claude-Opus · fewshot10 · n=50` | 272 | **64.99** | 55.52 | 7.44 | 47.43 | 32.99 |
| 24 | `bert × A3B-35B · fewshot10 · n=681` | 3762 | **64.47** | 54.72 | 7.42 | 46.57 | 33.27 |
| 25 | `bert-fixed × Qwen-27B · no-think · fewshot10 · n=50` | 286 | **64.25** | 52.62 | 7.59 | 46.85 | 37.81 |
| 26 | `bert-fixed × A3B-35B · fewshot10 · n=50` | 280 | **63.70** | 52.48 | 7.49 | 45.36 | 34.99 |
| 27 | `bert × Claude-Sonnet · raw · n=50` | 260 | **62.91** | 53.32 | 7.25 | 45.00 | 29.10 |
| 28 | `bert × Claude-Opus · top3 · EN · n=50` | 270 | **60.38** | 40.69 | 8.01 | 34.44 | 0.47 |
| ⚠️ 29 | `Claude-Opus × SocratTeachLLM · n=50` | 307 | **59.86** | 41.68 | 7.80 | 38.44 | 47.58 |
| ⚠️ 30 | `bert-fixed × SocratTeachLLM · fewshot10 · EN · n=50` | 273 | **58.22** | 48.97 | 6.75 | 43.22 | 48.07 |
| ⚠️ 31 | `qwen3.5 × SocratTeachLLM · fewshot10 · EN · n=50` | 291 | **57.20** | 48.66 | 6.57 | 43.99 | 46.73 |
| 32 | `bert × Claude-Opus · raw · n=50` | 239 | **55.63** | 43.27 | 6.80 | 39.75 | 23.28 |
| ⚠️ 33 | `qwen3.5 × SocratTeachLLM · CLEANPROBE · fewshot10 · SYNTH · n=50 · seed=42` ← STL on truly unseen data | 211 | **51.29** | 32.86 | 6.97 | 29.38 | 35.72 |
| ⚠️ 34 | `Claude-Opus × SocratTeachLLM · EN · n=50` | 304 | **50.73** | 33.79 | 6.77 | 30.26 | 44.22 |
| ⚠️ 35 | `Claude-Sonnet × SocratTeachLLM · clean · n=50` | 307 | **47.53** | 18.74 | 7.63 | 18.57 | 45.61 |
| ⚠️ 36 | `Claude-Sonnet × SocratTeachLLM · EN · n=50` | 303 | **44.36** | 22.55 | 6.62 | 22.11 | 55.85 |

**Key findings visible at a glance:**

1. **Frontier ≈ open-weight at parity, with a wider canonical-scale gap.** At the screening tier, best honest open-weight (`qwen3.5 × Gemma-31B`, #6, unified 68.94) sits 1.12 unified points behind the best frontier (`bert × Claude-Sonnet · top3 · n=681`, #2, 70.06). At canonical n=681 the gap is **1.41 pts** (legacy locked headline #7 → #2) or **2.25 pts** (new TODO #14 cell #3 at #11 → #2) — wider than the screening claim because the n=50 → n=681 promotion costs ~1 pt on stage_bal as closure dominance only emerges at full sampling. Three more TODO #14 cells remain queued before this gap is locked.
2. **Our locked headline (#7, n=681) survives the metric switch** at unified 68.65 — within 0.29 of the n=50 cross-teacher winner; unmoved by the first canonical-scale parity cell at #11.
3. **SocratTeachLLM's #8 ranking is contamination-driven.** On SocratDataset, `qwen3.5 × STL · ZH` lands #1 on stage_balanced (63.40, +4.72 over the next best) — but its score on clean synthetic data (cell #33, generated by Claude Sonnet, demonstrably outside SocratDataset's 90% train) collapses to 32.86 stage_bal / 35.72 R-1, *worse than Gemma 31B's 56.13/38.76 baseline*. STL's apparent excellence is ~12 R-1 points and ~29 state-acc points of memorization, not capability. Full proof in [`docs/SOCRATTEACHLLM_CONTAMINATION_PROOF.md`](docs/SOCRATTEACHLLM_CONTAMINATION_PROOF.md).
4. **Cross-lingual transfer of the qwen3.5 LoRA classifier works at canonical scale** (cell #21, unified 65.11 on SocratDataset-EN at n=400) — Stage 1 CONFIRMED; macro drop 9.24 pp < 10 pp gate. The earlier n=100 EN judge-bonus claim has been retracted as sampling noise (see paper Limitations §).

### Stage-balanced ranking — full 133 configs

<details>
<summary>Click to expand the complete 133-row stage-balanced ranking (every model variant we've tested in this project)</summary>
...
| 17 | `qwen3.5 × SocratTeachLLM · MEMPROBE · fewshot10 · TRAIN · n=50 · seed=42` | 297 | 55.22 | **57.81** | — | 48.28 |
| 18 | `tournament-cell-9-persona` | 275 | 51.27 | **57.65** | — | 39.60 |
| 19 | `qwen3.5 × Qwen-27B · phase3 · no-think · n=200 · seed=42` | 1172 | 52.13 | **57.45** | 7.56 | 37.11 |
| 20 | `bert × Claude-Sonnet · fewshot10 · n=50` | 267 | 47.94 | **57.32** | 7.84 | 39.68 |
| 21 | `bert × Claude-Sonnet · fewshot10 · n=50` | 281 | 48.75 | **57.18** | 8.11 | 43.02 |
| 22 | `tournament-cell-4-per_state_exemplars` | 285 | 50.88 | **57.18** | — | 39.42 |
| 23 | `bert-fixed × Qwen-27B · think · fewshot10 · n=50` | 271 | 49.08 | **57.15** | 7.41 | 34.91 |
| 24 | `bert-consultant-fewshot10-n50` | 276 | 48.19 | **57.03** | — | 35.57 |
| 25 | `bert × A3B-35B · n=mini` | 128 | 49.22 | **56.95** | — | 26.94 |
| 26 | `bert × Gemma-31B · fewshot10 · n=mini` | 137 | 50.36 | **56.87** | — | 35.93 |
| 27 | `bert × A3B-35B · composed · top3 · n=50` | 276 | 48.19 | **56.73** | 7.49 | 37.64 |
| 28 | `qwen3.5 × Gemma-31B · fewshot10 · n=50` | 285 | 51.58 | **56.13** | 8.18 | 38.76 |
| 29 | `bert-consultant-fewshot10-a4b-n50` | 274 | 48.54 | **56.12** | — | 37.49 |
| 30 | `bert × Claude-Opus · fewshot10 · n=50` | 272 | 47.43 | **55.52** | 7.44 | 32.99 |
| 31 | `qwen3.5 × Qwen-27B · no-think · fewshot10 · n=50` | 291 | 51.89 | **55.45** | 7.56 | 37.38 |
| 32 | `bert × Gemma-31B · fewshot10 · n=681` | 3834 | 48.15 | **55.42** | 8.19 | 36.78 |
| 33 | `tournament-cell-3-style_matched_exemplars` | 274 | 46.72 | **55.15** | — | 42.17 |
| 34 | `bert × A3B-35B · fewshot10 · n=681` | 3762 | 46.57 | **54.72** | 7.42 | 33.27 |
| 35 | `tournament-cell-8-nbest_rerank` | 281 | 47.33 | **53.61** | — | 38.27 |
| 36 | `bert × Claude-Sonnet · raw · n=50` | 260 | 45.00 | **53.32** | 7.25 | 29.10 |
| 37 | `tournament-cell-10-compressed_history` | 280 | 47.50 | **52.87** | — | 38.79 |
| 38 | `bert-fixed × Gemma-31B · fewshot10 · n=50` | 283 | 45.94 | **52.73** | 8.26 | 38.69 |
| 39 | `bert-consultant-richeval-mini` | 126 | 49.21 | **52.67** | — | 26.53 |
| 40 | `bert-fixed × Qwen-27B · no-think · fewshot10 · n=50` | 286 | 46.85 | **52.62** | 7.59 | 37.81 |
| 41 | `bert-fixed × A3B-35B · fewshot10 · n=50` | 280 | 45.36 | **52.48** | 7.49 | 34.99 |
| 42 | `tournament-cell-6-format_retry` | 282 | 46.45 | **52.36** | — | 39.60 |
| 43 | `bert × A3B-35B · n=50` | 261 | 44.06 | **52.31** | — | 28.36 |
| 44 | `qwen3.5 × Gemma-31B · fewshot10 · EN · RETRY · n=100 · seed=42` | 584 | 46.58 | **52.10** | 8.25 | 11.66 |
| 45 | `tournament-cell-2-lexical_priors` | 262 | 43.89 | **50.97** | — | 39.12 |
| 46 | `qwen3.5 × Gemma-31B · fewshot10 · EN · PARTIAL · n=61` | 351 | 45.01 | **50.84** | 8.25 | 10.88 |
| 47 | `qwen3.5 × Qwen-27B · phase3 · think · BROKEN · n=200 · seed=42` | 1245 | 46.51 | **50.82** | — | 15.07 |
...
| 50 | `qwen27b-local-mini-unified` | 146 | 45.89 | **50.16** | — | 29.36 |
| 51 | `qwen35b-a3b-local-mini-unified-fewshot7` | 148 | 45.27 | **49.78** | — | 35.69 |
| 52 | `qwen35b-a3b-local-n50-unified-fewshot10` | 299 | 44.15 | **49.34** | — | 36.16 |
| 53 | `qwen3.5 × Gemma-31B · fewshot10 · EN · canonical · n=400 · seed=42` | 2324 | 42.34 | **49.12** | 8.11 | 10.45 |
| 54 | `bert-v2-consultant-fewshot10-mini` | 142 | 44.37 | **49.08** | — | 33.55 |
| 55 | `bert-fixed × SocratTeachLLM · fewshot10 · EN · n=50` | 273 | 43.22 | **48.97** | 6.75 | 48.07 |
| 56 | `qwen3.5 × SocratTeachLLM · fewshot10 · EN · n=50` | 291 | 43.99 | **48.66** | 6.57 | 46.73 |
| 57 | `tournament/round1/qwen27b-q4` | 300 | 43.00 | **48.35** | — | 31.62 |
| 58 | `tournament/round1/qwen27b` | 302 | 42.72 | **48.21** | — | 30.90 |
| 59 | `gemma4-31b-local-mini-unified` | 148 | 41.89 | **46.32** | — | 30.11 |
| 60 | `qwen35b-a3b-local-mini-unified-fewshot` | 148 | 43.24 | **45.74** | — | 33.49 |
| 61 | `tournament/archive/368b6431/round1/gemma4-31b` | 305 | 40.33 | **44.99** | — | 32.88 |
| 62 | `tournament/archive/d9ac39c5/round1/gemma4-31b` | 304 | 41.12 | **44.72** | — | 32.96 |
| 63 | `qwen35b-a3b-local-unified` | 4171 | 38.70 | **44.05** | — | 30.63 |
| 64 | `tournament/archive/d9ac39c5/round1/gemma4-26b-a4b` | 303 | 39.27 | **43.49** | — | 31.60 |
| 65 | `gemma4-26b-a4b-local-mini-unified` | 147 | 38.78 | **43.31** | — | 32.04 |
| 66 | `bert × Claude-Opus · raw · n=50` | 239 | 39.75 | **43.27** | 6.80 | 23.28 |
| 67 | `tournament/archive/497374dd/round1/gemma4-26b-a4b` | 300 | 38.67 | **43.03** | — | 32.19 |
| 68 | `qwen35b-a3b-local-mini-unified-fewshot5` | 146 | 38.36 | **42.85** | — | 34.60 |
| 69 | `tournament/round1/gemma4-31b` | 303 | 38.28 | **42.19** | — | 33.04 |
| 70 | `qwen35b-a3b-local-n50-unified` | 299 | 38.13 | **42.11** | — | 32.87 |
| 71 | `qwen35b-a3b-local-n50-unified-fewshot` | 298 | 37.58 | **41.96** | — | 33.33 |
| 72 | `tournament/round1/gemma4-26b-a4b` | 303 | 37.62 | **41.78** | — | 32.48 |
| 73 | `Claude-Opus × SocratTeachLLM · n=50` | 307 | 38.44 | **41.68** | 7.80 | 47.58 |
| 74 | `tournament/archive/368b6431/round1/gemma4-26b-a4b` | 298 | 36.24 | **40.85** | — | 31.95 |
| 75 | `bert × Claude-Opus · top3 · EN · n=50` | 270 | 34.44 | **40.69** | 8.01 | 0.47 |
| 76 | `qwen35b-a3b-local-mini-unified` | 145 | 35.17 | **39.67** | — | 30.51 |
| 77 | `tournament/archive/497374dd/round1/gemma4-31b` | 304 | 35.86 | **39.58** | — | 33.03 |
| 78 | `tournament/round1/qwen35b-a3b` | 300 | 34.33 | **38.32** | — | 31.28 |
| 79 | `qwen27b-local-mini-unified-nothink` | 147 | 35.37 | **37.79** | — | 31.14 |
| 80 | `tournament/round1/qwen35-9b` | 297 | 32.66 | **36.30** | — | 34.49 |
| 81 | `tournament/archive/368b6431/round1/qwen27b-q4` | 303 | 31.68 | **36.00** | — | 32.84 |
| 82 | `gemma4-31b-local-unified` | 4246 | 31.39 | **35.60** | — | 27.27 |
| 83 | `tournament/archive/d9ac39c5/round1/qwen27b` | 307 | 31.60 | **35.51** | — | 33.33 |
| 84 | `tournament/archive/368b6431/round1/qwen27b` | 305 | 31.48 | **35.37** | — | 33.56 |
| 85 | `Claude-Opus × SocratTeachLLM · EN · n=50` | 304 | 30.26 | **33.79** | 6.77 | 44.22 |
| 86 | `tournament/archive/497374dd/round1/qwen27b-q4` | 300 | 30.67 | **33.13** | — | 33.25 |
| 87 | `qwen3.5 × SocratTeachLLM · CLEANPROBE · fewshot10 · SYNTH · n=50 · seed=42` | 211 | 29.38 | **32.86** | 6.97 | 35.72 |
| 88 | `qwopus35b-a3b-local-mini-unified` | 146 | 30.14 | **32.69** | — | 35.39 |
| 89 | `tournament/archive/497374dd/round1/qwen27b` | 304 | 28.62 | **32.35** | — | 33.42 |
| 90 | `baseline` | 4294 | 25.94 | **30.75** | — | 44.61 |
| 91 | `tournament/archive/d9ac39c5/round1/qwen27b-q4` | 302 | 26.82 | **30.02** | — | 33.32 |
| 92 | `tournament/round1/qwopus35b-a3b` | 305 | 25.90 | **28.88** | — | 35.50 |
| 93 | `tournament/archive/368b6431/round1/qwen3-14b` | 308 | 24.68 | **27.35** | — | 39.33 |
| 94 | `tournament/archive/368b6431/round1/qwen35b-a3b` | 306 | 24.18 | **27.09** | — | 31.69 |
| 95 | `tournament/archive/d9ac39c5/round1/qwen3-14b` | 308 | 23.70 | **25.89** | — | 40.44 |
| 96 | `tournament/archive/497374dd/round1/qwen3-14b` | 307 | 22.48 | **24.88** | — | 39.49 |
| 97 | `tournament/archive/d9ac39c5/round1/qwopus35b-a3b` | 301 | 21.93 | **24.43** | — | 33.38 |
| 98 | `tournament/round1/mistral-24b` | 304 | 21.38 | **23.99** | — | 37.45 |
| 99 | `tournament/archive/d9ac39c5/round1/qwen35b-a3b` | 297 | 21.55 | **23.99** | — | 31.43 |
| 100 | `tournament/archive/497374dd/round1/mistral-24b` | 302 | 21.85 | **23.61** | — | 37.06 |
| 101 | `tournament/archive/368b6431/round1/mistral-24b` | 308 | 20.13 | **23.35** | — | 37.49 |
| 102 | `Claude-Sonnet × SocratTeachLLM · EN · n=50` | 303 | 22.11 | **22.55** | 6.62 | 55.85 |
| 103 | `qwen35b-a3b-local-n50-unified-nothink` | 300 | 19.67 | **22.20** | — | 30.55 |
| 104 | `tournament/archive/d9ac39c5/round1/qwen35-9b` | 305 | 19.02 | **21.88** | — | 28.41 |
| 105 | `tournament/archive/497374dd/round1/qwen35b-a3b` | 304 | 19.74 | **21.86** | — | 31.30 |
| 106 | `wave-2026-04-21T08-59-20-892964` | 4280 | 18.93 | **21.62** | — | 43.72 |
| 107 | `tournament/archive/497374dd/round1/qwopus35b-a3b` | 307 | 18.57 | **21.41** | — | 32.81 |
| 108 | `tournament/archive/368b6431/round1/qwopus35b-a3b` | 307 | 17.92 | **20.73** | — | 33.13 |
| 109 | `tournament/archive/d9ac39c5/round1/gemma3-27b` | 306 | 18.30 | **20.15** | — | 34.35 |
| 110 | `tournament/archive/d9ac39c5/round1/mistral-24b` | 307 | 17.26 | **19.87** | — | 37.48 |
| 111 | `Claude-Sonnet × SocratTeachLLM · clean · n=50` | 307 | 18.57 | **18.74** | 7.63 | 45.61 |
| 112 | `R9700_Mac-M4` | 4262 | 15.16 | **18.41** | — | 43.57 |
| 113 | `tournament/round1/qwen3-14b` | 306 | 17.65 | **18.37** | — | 36.40 |
| 114 | `baseline_run1_en_bug` | 3978 | 15.08 | **17.92** | — | 0.29 |
| 115 | `tournament/archive/497374dd/round1/qwen35-9b` | 307 | 15.64 | **17.68** | — | 28.23 |
| 116 | `tournament/archive/368b6431/round1/gemma3-27b` | 308 | 14.61 | **17.18** | — | 34.86 |
| 117 | `tournament/archive/368b6431/round1/qwen35-9b` | 305 | 13.77 | **15.23** | — | 28.46 |
| 118 | `tournament/round1/gemma3-27b` | 307 | 14.33 | **15.14** | — | 34.61 |
| 119 | `tournament/archive/497374dd/round1/gemma3-27b` | 308 | 12.99 | **15.09** | — | 34.57 |
| 120 | `tournament/archive/368b6431/round1/glm47-23b` | 304 | 13.49 | **15.06** | — | 32.43 |
| 121 | `tournament/archive/497374dd/round1/glm47-23b` | 304 | 13.16 | **14.68** | — | 33.00 |
| 122 | `tournament/archive/368b6431/round1/phi4-14b` | 290 | 12.41 | **13.51** | — | 34.58 |
| 123 | `tournament/archive/d9ac39c5/round1/deepseek-r1-14b` | 307 | 11.40 | **13.43** | — | 34.43 |
| 124 | `tournament/archive/d9ac39c5/round1/phi4-14b` | 308 | 11.04 | **12.53** | — | 35.80 |
| 125 | `tournament/archive/497374dd/round1/phi4-14b` | 301 | 10.63 | **12.24** | — | 35.75 |
| 126 | `tournament/round1/deepseek-r1-14b` | 307 | 10.75 | **12.15** | — | 34.62 |
| 127 | `tournament/archive/368b6431/round1/deepseek-r1-14b` | 306 | 10.13 | **11.05** | — | 35.27 |
| 128 | `tournament/round1/phi4-14b` | 298 | 9.73 | **10.70** | — | 35.64 |
| 129 | `tournament/archive/d9ac39c5/round1/glm47-23b` | 305 | 9.51 | **10.67** | — | 30.90 |
| 130 | `tournament/archive/497374dd/round1/deepseek-r1-14b` | 306 | 8.17 | **9.24** | — | 35.70 |
| 131 | `Claude-Opus × SocratTeachLLM · BROKEN · n=50` | 308 | 0.00 | **0.00** | — | 13.20 |
| 132 | `Claude-Sonnet × SocratTeachLLM · n=50` | 308 | 0.00 | **0.00** | — | 43.88 |
| 133 | `Claude-Sonnet × SocratTeachLLM · BROKEN · n=50` | 308 | 0.00 | **0.00** | — | 13.20 |
