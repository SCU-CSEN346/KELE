...
_EXEMPLARS_BY_STAGE: dict[str, list[dict]] = {
    "a": [
        {
            "state": "a1",
            "student": '植物的种子通常在哪个部分（）["花", "叶", "果实"]',
            "teacher": "好的，这是一个有趣的问题！你觉得植物的种子会被放在一个什么样的地方呢？",
        },
        {
            "state": "a1",
            "student": '帮我解答一下这道题：蘑菇是植物。"Yes", "No"',
            "teacher": "你觉得蘑菇和树或者花有什么相似和不同的地方呢？",
        },
    ],
    "b": [
        {
            "state": "b2",
            "student": "嗯，叶子会变绿，然后最后变黄掉落。",
            "teacher": "叶子在变绿的时候，它在做什么呢？",
        },
        {
            "state": "b2",
            "student": "可能和水有关吧。",
            "teacher": "除了水，你觉得还有什么因素会影响豆芽的生长呢？",
        },
    ],
    "c": [
        {
            "state": "c22",
            "student": "哦，我记得是从种子开始的。",
            "teacher": "很好！你能解释一下为什么植物是从种子开始生长的吗？",
        },
        {
            "state": "c29",
            "student": "嗯，我觉得不太一样，青苔的根可能比较小。",
            "teacher": "实际上，青苔没有真正的根，只有假根用于固定。你觉得为什么之前没有想到这一点呢？",
        },
    ],
    "d": [
        {
            "state": "d33",
            "student": "需要，因为土壤干了，植物可能会渴。",
            "teacher": "很好！现在我们可以总结一下：植物的需水量会受到天气和土壤湿度的影响。你能根据这个总结回答题目吗？",
        },
        {
            "state": "d33",
            "student": "因为根可以深入土壤，吸收深层的水分。",
            "teacher": "没错，根系发达是骆驼刺在沙漠中生存的重要原因。那么，现在你能回答这道题了吗？",
        },
    ],
    "e": [
        {
            "state": "e34",
            "student": "答案是根。",
            "teacher": "很好！根是植物用来吸收水分和养分的器官，同时也帮助植物固定在土壤中。",
        },
        {
            "state": "e34",
            "student": "我想答案是'Yes'，因为有些植物可以在水中生长。",
            "teacher": "非常好！植物可以在不同的环境中生长，包括陆地和水中。",
        },
    ],
}
